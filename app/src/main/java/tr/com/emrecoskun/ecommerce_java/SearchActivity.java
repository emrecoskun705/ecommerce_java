...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get the product list by given search text
        getProductListBySearch(searchBy, foundProductText, productListView);
    ...
    private void getProductListBySearch(String searchBy, TextView foundProductText, ListView productListView) {
